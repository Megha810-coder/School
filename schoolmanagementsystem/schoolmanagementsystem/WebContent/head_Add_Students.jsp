                  ...
                  <form  action="head_Add_Students" method="POST" >
                   <center><h2 class="title"><font color="black">Add Details</h2></center>
                        ...
                        <div class="input-group">
                         ...
                         <div class="col-2">
                                <div class="input-group">
                                    <input class="input--style-4" type="text" name="age" placeholder="Enter Your Age" maxlength="2" pattern="[0-9]" required>
                                </div>
                            </div>
                        </div>
                         <div class="row row-space">
                        ...
                        <div class="input-group">
                         ...
                         <div class="col-2">
                              <div class="input-group">
                                    <input class="input--style-4" type="text" name="mother_name" placeholder="Mother's Name" required>
                                </div>
                            </div>
                        </div>
                       <div class="p-t-15">
